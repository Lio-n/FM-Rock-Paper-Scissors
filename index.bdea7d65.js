...
// ? COMPONENTS
var _headerScore = require("./components/header-score/header-score");
var _myHand = require("./components/my-hand/my-hand");
var _rules = require("./components/rules/rules");
// ? PAGES
...
},{"./components/header-score/header-score":"kkHF1","./components/my-hand/my-hand":"uWIna","./components/rules/rules":"e6RDy","./pages/home/home":"lu43V","./pages/results/results":"3R4Je","./router.ts":"6Aetg","./state":"4v8yo"}],"kkHF1":[function(require,module,exports) {
...
class Header extends HTMLElement {
    constructor(){
        ...
        this.logoURL = logo;
        this.score = _state.state.getState().history; // * I get the score of the state.ts
        this.render();
    }
    render() {
...
},{"url:../../assets/images/logo.svg":"60hsV","../../state":"4v8yo","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"60hsV":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('2VWEd') + "logo.a80f8dd9.svg" + "?" + Date.now();
...
const state = {
    ...
    whoWin (myPlay, botPlay) {
        ...
        result = [
            ...
            winPaper,
            winRock
        ].includes(true) ? "Win" : "Lose";
        result == "Win" ? this.pushToHistory({
            myScore: 1,
            botScore: 0
        }) : this.pushToHistory({
            myScore: 0,
...
},{}],"uWIna":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"url:../../assets/images/icon-rock.svg":"7VcZp","url:../../assets/images/icon-paper.svg":"eWSV2","url:../../assets/images/icon-scissors.svg":"lKzZg","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"7VcZp":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('2VWEd') + "icon-rock.339c8e28.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"chiK4"}],"eWSV2":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('2VWEd') + "icon-paper.6b006b0b.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"chiK4"}],"lKzZg":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('2VWEd') + "icon-scissors.5f2c9c8e.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"chiK4"}],"e6RDy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"url:../../assets/images/image-rules.svg":"eBrhV","url:../../assets/images/icon-close.svg":"2HSPw","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"eBrhV":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('2VWEd') + "image-rules.300b08a9.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"chiK4"}],"2HSPw":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('2VWEd') + "icon-close.e6450cc9.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"chiK4"}],"lu43V":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Home extends HTMLElement {
    ...
    addListener() {
        ...
        const userMove = ()=>{
            ...
            for (const choice of myMove)choice.addEventListener("change", (e)=>{
                const botMove = botMoveRm();
                _state.state.setMove(e.detail.myPlay, botMove);
                _router.Router.go("/results");
            });
        };
        userMove();
    }
...
},{"@vaadin/router":"5sGjx","../../state":"4v8yo","url:../../assets/images/bg-triangle.svg":"fW8kn","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"5sGjx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"fW8kn":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('2VWEd') + "bg-triangle.576071b4.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"chiK4"}],"3R4Je":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Result extends HTMLElement {
    constructor(){
        ...
        this.plays = _state.state.getState().currentGame;
        this.render();
    }
    addListener() {
    ...
    render() {
        const { myPlay , botPlay  } = this.plays;
        // * Check who won
        const whoWin = _state.state.whoWin(myPlay, botPlay);
...
},{"@vaadin/router":"5sGjx","../../state":"4v8yo","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"6Aetg":[function(require,module,exports) {
var _router = require("@vaadin/router");
(()=>{
...
},{"@vaadin/router":"5sGjx"}]},["2HtCd","7PGg5"], "7PGg5", "parcelRequire784c")
